                    ...
                    if (!this.hasOverriddenDndUpload) {
                        ...
                        M.course_dndupload.file_handler_dialog = function (handlers, extension, file, section, sectionnumber) {
                            ...
                            var panel = new M.core.dialogue({
                                headerContent: '<div class="moodle-dialogue-equella-header"><img src="../mod/equella/pix/equella-blue.png" width="20px"/><span><b>Te Kete Contribution Tool</b></span><br><span>This adds the resource to Te Kete (Equella)</span></div>',
                                bodyContent: content,
                                width: '700px',
                                modal: true,
                                visible: true,
